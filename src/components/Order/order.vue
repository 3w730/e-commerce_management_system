  ...
  <div>
    ...
    <el-card>
      ...
      <el-table border stripe :data="ordersList">
        ...
        <el-table-column prop="goods_number" label="下单时间">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" icon="el-icon-edit" @click="showEditDialog(scope.row)"></el-button>
            <el-button size="mini" type="success" icon="el-icon-date" @click="showProgressDialog"></el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="修改地址" :visible.sync="editDialogVisiable" width="50%" @close="editDialogClose">
